...
class RSIIndicator(VectorizedIndicator):
    ...
    def __init__(self, period: int = 14, use_numba: bool = True) -> None:
...
class MACDIndicator(VectorizedIndicator):
    ...
    def compute(self, data: pd.DataFrame, **kwargs) -> IndicatorResult:
        ...
        try:
            ...
            return IndicatorResult(
                value=macd_df,
  # Return full time series DataFrame
                confidence=confidence,
                metadata={
...
class BollingerBandsIndicator(VectorizedIndicator):
    ...
    def __init__(self, period: int = 20, std_dev: float = 2.0, use_numba: bool = True) -> None:
...
class VolumeProfileIndicator(VectorizedIndicator):
    ...
    def __init__(self, lookback: int = 90, num_buckets: int = 20) -> None:
