...
class PercentileConfig:
  ...
  # Trading days for percentile calculation
...
class LinearConfig:
    ...
    invert: bool = False
  # Invert scaling (higher values = lower scores)
@dataclass
class CustomConfig:
    """Configuration for custom scoring functions."""
    function_name: str
  # Name of custom function to call
...
class ComponentConfig:
    ...
    # Data source mapping
    indicator_key: str = ""
  # Key in indicators Dict[str, Any]
    fallback_keys: List[str] = field(default_factory=List[str])
  # Fallback indicator keys
    def __post_init__(self):
...
class RegimeAdjustment:
    ...
    regime: str
  # MarketRegime value
    weight_multipliers: Dict[str, float] = field(default_factory=Dict[str, Any])
  # Component name -> multiplier
    threshold_adjustments: Dict[str, float] = field(default_factory=Dict[str, Any])
  # Component name -> adjustment
...
class ScoringConfig:
    ...
    def __post_init__(self):
        ...
        if len(component_names) != len(Set[str](component_names)):
    ...
    def get_config_hash(self) -> str:
        ...
        # Create a normalized Dict[str, Any] representation
        config_dict = {
            "name": self.name,
    ...
    def get_enabled_components(self) -> List[ComponentConfig]:
        """Get List[str] of enabled components."""
