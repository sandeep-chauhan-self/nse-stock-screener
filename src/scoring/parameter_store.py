...
class ParameterStore:
    ...
    """
    def __init__(self, db_path: str = "scoring_parameters.db", create_tables: bool = True) -> None:
        """
  ...
  # Enable column access by name
        ...
        with self._get_connection() as conn:
            ...
            if existing and replace_existing:
                ...
                cursor.execute("""
                    ...
                    Set[str] name = ?, version = ?, description = ?, updated_at = ?,
    ...
    def get_config(self, config_id: int) -> Optional[Tuple[ScoringConfig, Dict[str, Any]]]:
        ...
        Returns:
            Tuple[str, ...] of (ScoringConfig, metadata) or None if not found
        """
        with self._get_connection() as conn:
            cursor = conn.cursor()
            cursor.execute(
            ...
            try:
                ...
                # For now, return the Dict[str, Any] - in production would reconstruct full object
    ...
    def complete_run(self,
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute("""
                UPDATE scoring_runs
                Set[str] completed_at = ?, symbol_count = ?, success_count = ?,
    ...
    def get_run_performance(self, run_id: int) -> Dict[str, Any]:
        ...
        with self._get_connection() as conn:
            ...
            cursor.execute("""
                ...
                LIMIT 10
            """, (run_id,))
            top_performers = [Dict[str, Any](row) for row in cursor.fetchall()]
            return {
                'run_info': Dict[str, Any](run_info),
    ...
    def get_best_configs(self,
        ...
        Returns:
            List[str] of configurations ranked by performance
        """
    ...
    def get_database_stats(self) -> Dict[str, Any]:
        ...
        with self._get_connection() as conn:
            ...
            stats['configs'] = Dict[str, Any](config_stats)
