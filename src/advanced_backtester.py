...
class TradeResult:
    ...
    take_profit: float
    exit_reason: str
  # 'stop_loss', 'take_profit', 'time_exit', 'manual'
    days_held: int
...
class AdvancedBacktester:
  ...
  # Use centralized config
    ...
    def calculate_slippage_cost(self, quantity: int, price: float,
                              avg_volume: Optional[float] = None, symbol: Optional[str] = None) -> Dict[str, float]:
        """
  ...
  # liquidity_based
    ...
    def apply_execution_costs(self, trade_value: float, quantity: int,
                            ...
                            avg_volume: Optional[float] = None, symbol: Optional[str] = None) -> Dict[str, Any]:
        """
  ...
  # Buffer for stop loss calculation
  ...
  # Default 2% if no ATR
            ...
            # At this point, exit_price is guaranteed to be a float (not None)
            ...
            return None
    def walk_forward_backtest(self, signals_data: Dict[str, List[Dict[str, Any]]],
                            start_date: datetime, end_date: datetime) -> Dict[str, Any]:
        """
        Perform walk-forward backtesting
        signals_data: {symbol: [{'date': datetime, 'signal_data': Dict[str, Any]}, ...]}
        """
                    ...
                    for signal in signal_list:
                        ...
                        if (signal_date and
                            ...
                            if trade_result:
                                ...
                                break
  # Only one signal per symbol per day
