...
def test_execution_cost_integration():
    ...
    avg_volume = 20000  # Small volume for impact testing
...
def test_partial_fills():
    ...
    config.liquidity_impact_threshold = 0.02  # 2% of volume triggers impact
    backtester = AdvancedBacktester(config)
    
    # Test case: Large order vs small volume
    quantity = 1000
    price = 300.0
    avg_volume = 10000  # Order is 10% of volume
...
def test_realistic_indian_costs():
    ...
    quantity = 100
    price = 2500.0  # Expensive stock like RIL
    trade_value = quantity * price
    
    print(f"Typical Indian Equity Trade:")
    ...
    print(f"This matches typical Indian brokerage + taxes")
...
def demonstrate_improvements():
    ...
    old_cost = trade_value * (config.transaction_cost + 0.0005)  # Old slippage as %
