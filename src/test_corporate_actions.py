...
def test_corporate_action_detection():
    ...
    for symbol in test_symbols:
        ...
        try:
            ...
            print(f"  Corporate Action Summary:")
            ...
            if ca_events['events']:
                ...
                for event in ca_events['events'][-2:]:  # Show last 2 events
...
def test_adjusted_vs_raw_prices():
    ...
    try:
        ...
        if raw_data is not None and adjusted_data is not None:
            ...
            significant_adjustments = abs(price_ratio - 1.0) > 0.01  # 1% difference
            ...
            if adjustment_count > 0:
                print(f"  ✅ Corporate action adjustments detected")
            else:
...
def test_indicator_consistency():
    ...
    for symbol in test_symbols:
        ...
        try:
            ...
            if indicators:
                print(f"  ✅ Successfully computed indicators:")
