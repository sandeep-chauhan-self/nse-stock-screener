...
class PortfolioRiskController:
    ...
    def __init__(self, risk_config: RiskConfig):
        ...
        # Alert tracking
        self._active_alerts: Dict[RiskAlert, List[str]] = defaultdict(list)
    ...
    def check_position_correlation(
        ...
        Returns:
            Tuple of (max_correlation, warnings)
        """
        warnings_list = []
    ...
    def calculate_risk_adjusted_position_size(
        ...
        Args:
            ...
            portfolio_state: Current portfolio state
            risk_factors: Dict of risk factor names and values
        ...
        if cash_utilization > 0.8:  # 80% deployed
        ...
        min_size = base_position_size * 0.1  # At least 10% of base
        max_size = base_position_size * 1.0   # No increase above base
    ...
    def get_risk_alerts(self, active_only: bool = True) -> Dict[RiskAlert, List[str]]:
        ...
        Returns:
            Dictionary of alert type -> list of messages
        """
        if active_only:
    ...
    def _assess_correlation_risk(
        ...
        if self._correlation_matrix is None:
            risk_details['correlation_risk'] = 0.5  # Unknown risk
            return 0.5, alerts
    ...
    def _assess_liquidity_concentration(
        ...
        if illiquid_pct > 0.2:  # 20% threshold
        ...
        risk_details.update({
            ...
            'tier_distribution': dict(tier_values)
        })
