...
from typing import Dict[str, Any], List[str], Optional, Any, Tuple[str, ...], Union
...
class BacktestReportGenerator:
    ...
    def generate_comprehensive_report(self,
        ...
        Args:
            ...
            formats: List[str] of formats to generate
        Returns:
  ...
  # Only if we have enough data
            ...
            # Rolling metrics
            if len(returns) > 252:
  # Only if we have at least 1 year of data
