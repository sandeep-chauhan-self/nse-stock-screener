...
class BenchmarkType(Enum):
    ...
    ABSOLUTE = "absolute"  # Compare to zero return
    INDEX = "index"       # Compare to market index
    RISK_FREE = "risk_free"  # Compare to risk-free rate
    CUSTOM = "custom"     # Custom benchmark series
