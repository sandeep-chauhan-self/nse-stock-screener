...
from typing import Dict[str, Any], List[str], Optional, Tuple[str, ...], Callable, Any, Iterator
import warnings
...
class WalkForwardConfig:
  ...
  # 1 month validation
    ...
    min_train_window_days: int = 126
  # 6 months minimum
    min_test_window_days: int = 21
    # 1 month minimum
...
class LookaheadDetector:
    ...
    def check_data_timestamps(self, data: pd.DataFrame,
        ...
        Returns:
            List[str] of bias check results
        """
        checks = []
    ...
    def validate_backtest_data(self, data: Dict[str, pd.DataFrame],
        ...
        Returns:
            List[str] of all bias check results
        """
        all_checks = []
    ...
    def create_walk_forward_splits(self, start_date: datetime,
        ...
        while current_date < end_date:
            ...
            if train_end > end_date:
                break
  # Not enough data for complete train window
            ...
            if test_end > end_date:
                break
  # Not enough data for complete test window
            # Create train split
    ...
    def get_rebalance_dates(self, start_date: datetime,
        ...
        rebalance_dates = sorted(Set[str](rebalance_dates))
...
class TimeSeriesCrossValidator:
    ...
    def create_cv_splits(self, start_date: datetime, end_date: datetime) -> List[Tuple[DataSplit, DataSplit]]:
        ...
        Args:
            ...
            end_date: End date
        Returns:
            List[str] of (train_split, test_split) tuples
        """
        total_days = (end_date - start_date).days
