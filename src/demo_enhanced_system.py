...
def run_basic_analysis():
    ...
    # Initialize with default stocks (smaller List[str] for demo)
    demo_stocks = [
...
if __name__ == "__main__":
  ...
  # Exit program
        ...
        logging.warning("python enhanced_early_warning_system.py
                    # Default analysis")
        logging.warning("python enhanced_early_warning_system.py -f stocks.txt
     # From file")
        logging.warning("python enhanced_early_warning_system.py -s RELIANCE,TCS
   # Custom stocks")
        logging.warning("python enhanced_early_warning_system.py --backtest
        # With backtesting")
        logging.warning("python enhanced_early_warning_system.py -b 20 -t 5
