...
class EarlyWarningSystem:
    def __init__(self, custom_stocks=None, input_file=None, batch_size=50, timeout=5):
        ...
        if input_file:
            ...
            # Use provided list of custom stocks
    ...
    def momentum_acceleration_detector(self, symbol):
        ...
        try:
            ...
            # Momentum score
            momentum_score = 0
            if 60 <= current_rsi <= 80:  # Sweet spot for momentum
                momentum_score += 2
            if current_macd > current_signal:  # MACD bullish
                momentum_score += 2
            if current_macd > 0:  # MACD above zero
                momentum_score += 1
            ...
            for i, symbol in enumerate(batch):
                ...
                try:
                    ...
                    if volume_signal and momentum_signal:
                        ...
                        if combined_score >= 5:  # High probability threshold
                            high_probability_stocks.append(stock_data)
                        elif combined_score >= 3:  # Medium probability
