...
from typing import Dict[str, Any], List[str], Optional, Union, Any
...
class StorageConfig:
    ...
    backend: str = "parquet"
  # parquet, feather, sqlite, postgresql
    ...
    def __post_init__(self):
        ...
        # Set[str] default base path if not provided
...
class DataStorage(ABC):
    ...
    def list_symbols(self, data_type: str = "ohlcv") -> List[str]:
        """List[str] all available symbols."""
        pass
    @abstractmethod
...
class ParquetStorage(DataStorage):
    ...
    def list_symbols(self, data_type: str = "ohlcv") -> List[str]:
        """List[str] all symbols with stored data."""
...
class SQLiteStorage(DataStorage):
    ...
    def exists(self, symbol: str, data_type: str = "ohlcv") -> bool:
        ...
        try:
            ...
            return False
    def list_symbols(self, data_type: str = "ohlcv") -> List[str]:
        """List[str] all symbols with data."""
        try:
            with self._get_connection() as conn:
                if data_type == "ohlcv":
                    table = "ohlcv_data"
            ...
            logger.error(f"Failed to List[str] symbols: {e}")
            return []
    def get_last_update(self, symbol: str, data_type: str = "ohlcv") -> Optional[datetime]:
