...
class DataRequest:
    ...
    start_date: date
    end_date: date
    data_type: str = "ohlcv"  # ohlcv, corporate_actions, fundamentals
    frequency: str = "1d"     # 1d, 1h, 5m, etc.
    adjusted: bool = True     # Return adjusted prices
...
class DataConnector(ABC):
    ...
    def get_available_symbols(self) -> List[str]:
        """Get list of available symbols from this connector."""
        pass
...
class YfinanceConnector(DataConnector):
    ...
    def _fetch_historical_data(self, request: DataRequest) -> pd.DataFrame:
        ...
        data = ticker.history(
            ...
            end=request.end_date + timedelta(days=1),  # yfinance end is exclusive
