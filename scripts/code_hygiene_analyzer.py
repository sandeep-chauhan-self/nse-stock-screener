...
class ASTAnalyzer(ast.NodeVisitor, object):
    ...
    def visit_ClassDef(self, node: ast.ClassDef) -> None:
        ...
        # Set[str] current class context for method processing
  ...
  # Docstring
        ...
        for stmt in body:
            ...
            return True
        return False
class CodeHygieneAnalyzer(object):
    ...
    def analyze_project(self) -> Dict[str, Any]:
        ...
        python_files = list(self.src_dir.rglob("*.py"))  # Convert to list of Path objects
    ...
    def _check_duplicate_imports(self, analysis: FileAnalysis):
        ...
        seen_imports = set()  # Set of import strings
  ...
  # Skip private functions
    ...
    def _analyze_global_issues(self) -> None:
    ...
    def _check_inconsistent_imports(self) -> None:
        """Check for inconsistent import patterns across files"""
        # Group imports by module
        module_imports = defaultdict(list)  # List of tuples (file_path, import_info)
        ...
        for module, imports in module_imports.items():
            if len(imports) > 1:
                ...
                import_styles = set()  # Set of import style strings
    ...
    def _check_module_organization(self) -> None:
